...
export const PatientList = () => {
  ...
  // tokens as SchoolCard/GradePill rather than inventing a new palette.
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {tickedIds.size > 0 && (
              <button
                ...
                className={`flex items-center gap-1 px-3 py-2 text-sm font-medium rounded-full ml-auto ${allTickedQueued ? 'text-primary border border-primary hover:bg-primary-surface' : 'text-white bg-primary hover:bg-primary-hover'}`}
              >
