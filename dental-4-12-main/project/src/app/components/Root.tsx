  ...
  return (
    ...
    <div className="min-h-screen bg-canvas flex flex-col md:flex-row" style={{ paddingTop: TOPBAR_H }}>
      ...
      <div
        ...
        className={`fixed top-0 right-0 left-0 ${collapsed ? 'md:left-[244px]' : 'md:left-[448px]'} z-[60] flex items-center justify-end gap-3 px-6 bg-white/80 backdrop-blur-xl border-b border-[#EEF2F7] leading-none transition-[left] duration-200`}
      >
      ...
      <aside
        ...
        className={`bg-sidebar-bg flex flex-col fixed left-0 top-0 h-screen z-[70]
          md:left-[84px] md:top-[84px] md:bottom-[84px] md:h-auto md:rounded-[28px] md:border md:border-white/10 md:shadow-[0_18px_45px_rgba(15,23,42,0.22)]
      ...
      <main className={`flex-1 ml-0 ${collapsed ? 'md:ml-[244px]' : 'md:ml-[448px]'} overflow-x-clip transition-[margin] duration-200`}>
