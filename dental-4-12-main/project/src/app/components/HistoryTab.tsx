        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <div>
            ...
            <input type="number" min="0" max="300" step="0.1" inputMode="decimal" disabled={!editing}
              ...
              placeholder="e.g. 120" className="w-full text-xs border border-border rounded px-2 py-1.5 focus:outline-none focus:ring-1 focus:ring-ring disabled:cursor-not-allowed" />
          </div>
          <div>
            ...
            <input type="number" min="0" max="500" step="0.1" inputMode="decimal" disabled={!editing}
              ...
              placeholder="e.g. 25" className="w-full text-xs border border-border rounded px-2 py-1.5 focus:outline-none focus:ring-1 focus:ring-ring disabled:cursor-not-allowed" />
          </div>
          <div>
            ...
            <input type="number" min="0" max="45" step="0.1" inputMode="decimal" disabled={!editing}
              ...
              placeholder="e.g. 36.5" className="w-full text-xs border border-border rounded px-2 py-1.5 focus:outline-none focus:ring-1 focus:ring-ring disabled:cursor-not-allowed" />
          </div>
          <div>
            ...
            <input type="text" disabled={!editing}
              ...
              placeholder="e.g. 110/70" className="w-full text-xs border border-border rounded px-2 py-1.5 focus:outline-none focus:ring-1 focus:ring-ring disabled:cursor-not-allowed" />
          </div>
          {(() => {
            ...
            return (
              <>
                <div>
                  ...
                  <div className="w-full text-xs border border-border rounded px-2 py-1.5 bg-muted text-muted-foreground" title={BMI_NOTE}>
                    {bmiValue ?? 'Automatic'}
                  </div>
                </div>
                <div className="col-span-2 sm:col-span-1">
                  <label className="block text-xs text-muted-foreground mb-1">Nutritional Status</label>
                  <div className={`w-full text-xs border border-border rounded px-2 py-1.5 ${statusColor}`}
