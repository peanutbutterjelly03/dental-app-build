      ...
      <div>
        <div className="mb-3 flex items-center gap-2">
          ...
          <button type="button" onClick={toggleNotes} aria-pressed={showNotes}
            className="ml-auto -mb-1 self-end text-xs font-normal leading-none text-primary underline underline-offset-2 hover:text-primary-hover">
          ...
          {weekDays.map((d) => {
            ...
            const inner = (
              <>
                ...
                <span className="block px-3 pt-3 pb-6">
